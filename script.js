...
function ajouterPomme(){
    ...
    const Pomme = new Panier(x.QtePomme, prixPomme, x.nouveauPricePomme);
...
function ajouterPoire(){
    ...
    const Poire = new Panier(x.QtePoire, prixPoire, x.nouveauPricePoire);
...
function ajouterPeche(){
    ...
    const Peche = new Panier(x.QtePeche, prixPeche, x.nouveauPricePeche);
